...
public class LevelView extends View {
    ...
    private Paint mCircleMarkPaint;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mCircleMarkPaint = new Paint();
        mCircleMarkPaint.setColor(Color.BLUE);
        mCircleMarkPaint.setStyle(Paint.Style.STROKE);
        mCircleMarkPaint.setStrokeWidth(mBubbleRuleWidth);
        mCircleMarkPaint.setAntiAlias(true);
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if(bubblePoint == null){
            bubblePoint = new PointF(centerPnt.x, centerPnt.y);
        }
        ...
        canvas.drawCircle(centerPnt.x, centerPnt.y, nRadius, mLimitPaint);

        canvas.drawLine(centerPnt.x - nRadius, centerPnt.y, centerPnt.x+nRadius, centerPnt.y, mCircleMarkPaint);
        canvas.drawLine(centerPnt.x, centerPnt.y - nRadius, centerPnt.x, centerPnt.y + nRadius, mCircleMarkPaint);
    ...
    public void setPosition(float px, float py) {
        ...
        bubblePoint = new PointF(centerPnt.x - px, centerPnt.y - py);
